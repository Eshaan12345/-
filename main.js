...
function preload() {
  whack_a_mole = loadSound("ball_touch_paddel.wav");
  oops = loadSound("missed.wav");
}
...
if(game_status == "start") // inside the if condition check if the game_status is equal to the value "start".
{
  ...
  if(scoreRightWrist > 0.2)
  {
    ...
    rect(paddle1X,paddle1,paddle1,paddle1Height,100);
...
if(pcscore ==4){
    ...
    text("Press Reload to restart the game!",width/2,height/2+30)
    noLoop();
    pcscore = 0;
 }
